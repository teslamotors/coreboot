...
enum timestamp_id {
	...
	TS_START_ULZ4F = 17,
	TS_END_ULZ4F = 18,
	TS_START_COPYLINUX = 19,
	TS_END_COPYLINUX = 20,
	TS_START_COPYDTB = 21,
	TS_END_COPYDTB = 22,
	TS_START_COPYINITRD = 23,
	TS_END_COPYINITRD = 24,
...
static const struct timestamp_id_to_name {
	...
	{ TS_START_COPYLINUX,	"starting to load linux" },
	{ TS_END_COPYLINUX,	"finished loading linux" },
	{ TS_START_COPYDTB,	"starting to load dtb" },
	{ TS_END_COPYDTB,	"finished loading dtb" },
	{ TS_START_COPYINITRD,	"starting to load initrd" },
	{ TS_END_COPYINITRD,	"finished loading initrd" },
